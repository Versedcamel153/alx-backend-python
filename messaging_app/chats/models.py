...
class User(models.Model):
    ...
    user_id = models.UUIDField(db_index=True, primary_key=True, editable=False, unique=True)
...
class Message(models.Model):
    message_id = models.UUIDField(db_index=True, primary_key=True, editable=False, unique=True)
    sender_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='sent_messages')
    message_body = models.TextField(null=False)
    sent_at = models.DateTimeField(auto_now_add=True)

class Conversation(models.Model):
    conversation_id = models.UUIDField(db_index=True, primary_key=True, editable=False, unique=True)
